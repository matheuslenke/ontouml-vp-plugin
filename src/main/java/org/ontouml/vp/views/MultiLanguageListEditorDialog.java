...
public class MultiLanguageListEditorDialog extends JDialog {
    ...
    public MultiLanguageListEditorDialog(Frame owner, String title, List<MultilingualText> initialData) {
    ...
    public static List<MultilingualText> showDialog(Component parent, String title, List<MultilingualText> initialData) {
        ...
        MultiLanguageListEditorDialog dialog = new MultiLanguageListEditorDialog(owner, title, initialData);
