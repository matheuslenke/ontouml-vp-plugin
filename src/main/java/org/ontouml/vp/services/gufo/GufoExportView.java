...
public class GufoExportView extends JPanel {
  ...
  private final JComboBox<String> packagesBox;

  private JComboBox<String> namesBox;
  private final JComboBox<String> languagesBox;
  private final JComboBox<String> packagesIdBox;
  private final JTabbedPane tabbedPane;
  private final JCheckBoxTree packageTree;
  private final JCheckBoxTree diagramTree;
  ...
  private final boolean wasCancelled = false;

  private final HashSet<String> elementsPackageTree = new HashSet<>();
  private final HashSet<String> elementsDiagramTree = new HashSet<>();

  private final IModelElement[] elementsMapping;
  private final IModelElement[] packagesMapping;
  ...
  public GufoExportView(ProjectConfigurations configurations) {
    ...
    languagesBox = new JComboBox<>(LanguageUtils.getLanguagesCode());
