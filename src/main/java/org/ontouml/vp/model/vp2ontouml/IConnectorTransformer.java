...
public class IConnectorTransformer {
  ...
  public static Path transform(IConnectorUIModel source, BinaryConnectorView target) {
    ...
    if (source.getFromShape() != null)
      connectorSource = source.getFromShape();
    else if (source.getFromConnector() != null)
      connectorSource = source.getFromConnector();
    ...
    if (source.getToShape() != null)
      connectorTarget = source.getToShape();
    else if (source.getToConnector() != null)
      connectorTarget = source.getToConnector();
