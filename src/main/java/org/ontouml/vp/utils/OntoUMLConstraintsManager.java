...
public class OntoUMLConstraintsManager {
  ...
  private static final String GENERALIZATION_CONSTRAINTS_FILENAME = "generalization_constraints.json";
  private static final String ASSOCIATION_CONSTRAINTS_FILENAME = "association_constraints_nature.json";

  private static final String ALLOWED_SUBCLASSES = "allowedSubClassesFor";
  private static final String ALLOWED_SUPERCLASSES = "allowedSuperClassesFor";
